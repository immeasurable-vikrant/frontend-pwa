...
const SearchedCourses = ({ hasError, courses, total, page, isLoading, getPaginate, fetchPaginateLoading, fetchPaginateReset, fetchSignError }) => {
...
const numberWithCommas = (x) => {
	...
	const renderCourses = () => {
		console.log('COURSERSSAAAAAAAAA',courses)
	...
	return (
		...
		<div style={{ backgroundColor: 'green', margin:'20px'}}>{renderState()}</div>
		</Fragment>
